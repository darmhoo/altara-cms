...
class ProductSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        ";
        $product->retail_price = "110100";
        $product->image_url = "polystar-fridge-3-medium.png";
        $product->user_id = 1;
        ...
        Manual defrost
        ";
        $product->retail_price = "106300";
        $product->image_url = "polystar-fridge-4-medium.png";
        $product->user_id = 2;
        $product->category_id = 1;
        ...
        $product->image_url = "polystar-fridge-6-medium.png";
        $product->user_id = 1;
        $product->category_id = 1;
        $product->save();
        //4
        ...
        $product->image_url = "polystar-fridge-7-medium.png";
        $product->user_id = 1;
        $product->category_id = 1;
        ...
        $product->image_url = "polystar-fridge-8-medium.png";
        $product->user_id = 1;
        $product->category_id = 1;
        ...
        Fast freezing function
        ";
        $product->retail_price = "192400";
        $product->image_url = "polystar-fridge-9-medium.png";
        $product->user_id = 1;
        $product->category_id = 1;
        $product->save();
      //7
        ...
        $product->retail_price = "122300";
        $product->image_url = "midea-fridge-2-medium.png";
        $product->user_id = 1;
        ...
        $product->image_url = "polystar-fridge-10-medium.png";
        $product->user_id = 1;
        $product->category_id = 2;
        $product->save();
        //9
        ...
        $product->image_url = "polystar-fridge-1-medium.png";
        $product->user_id = 1;
        $product->category_id = 2;
        $product->save();
        //10
        ...
        $product->image_url = "polystar-fridge-11-medium.png";
        $product->user_id = 1;
        $product->category_id = 2;
        $product->save();
        //13
