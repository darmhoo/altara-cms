                        ...
                        <form class="form-horizontal" v-on:submit.prevent>
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <select class="col-md-9 form-control" v-model="product.brand_id" name="brand" id="brand">
                            ...
                            <div class="card-footer ">
                                <div class="col-md-12 text-center">
                                    <button type="submit" @click="save" :disabled="isProcessing" class="btn btn-fill btn-info">{{action}} Product</button>
                                </div>
                            </div>
                        </form>
                    </div>
